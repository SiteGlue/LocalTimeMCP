...
import { ValidationError, TimezoneError } from './types.js';
 ...
 */
function getPostalCodeType(code) {
 ...
 */
function getUSTimezone(zipCode) {
 ...
 */
function getCanadianTimezone(postalCode) {
 ...
 */
export function getTimezoneFromPostalCode(code) {
 ...
 */
export function getCurrentTimeInTimezone(timezone, format = '12') {
    try {
 ...
 */
export function getCurrentDateInTimezone(timezone, format = 'medium') {
    try {
        const now = moment.tz(timezone);
        let dateFormat;
        switch (format) {
 ...
 */
export function getDateTimeFromPostalCode(code, options = {}) {
 ...
 */
export function getDateInTimezone(timezone, date, format = 'medium') {
    try {
 ...
 */
export function formatTimeForVoice(timezone, format = '12') {
 ...
 */
export function formatDateForVoice(timezone, format = 'medium') {
 ...
 */
export function formatDateTimeForVoice(timezone, options = {}) {
    const { timeFormat = '12', dateFormat = 'medium' } = options;
    const now = moment.tz(timezone);
    let voiceDateFormat;
    switch (dateFormat) {
